    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _init: function () {
            ...
            if (this.options.jsonConfig !== '' && this.options.jsonSwatchConfig !== '') {
                ...
                this._selectDefaultProcutIdByUrl();
        ...
        _EmulateSelected: function (selectedAttributes) {
           ...
           $.each(selectedAttributes, $.proxy(function (attributeCode, optionId) {
                ...
                + '[data-attribute-code="' + attributeCode + '"] .swatch-select').val(optionId).trigger('change');
        ...
        _ReplaceData: function (simpleProductId, $widget) {
            ...
            if ($widget.options.replaceBreadCrumbsData && typeof $widget.options.breadCrumbsData[simpleProductId] !== 'undefined') {
                var breadCrumb = $widget.options.breadCrumbsData[simpleProductId];
                if (breadCrumb !== 'undefined') {
                    $('div.breadcrumbs .items .product').html('<strong>'+breadCrumb+'</strong>');
                }
            }

            $(document).trigger('processScpRecentProductDataEvent', [simpleProductId]);
            this._disableEmptyFirstOption();
        },
        ...
        _selectDefaultProcutIdByUrl: function() {
            if (!this.options.productUrls || typeof this.options.productUrls !== 'object') {
                return;
            }
        ...
        _selectDefaultProcutId: function(simpleProductId) {
            var productData = this.options.jsonConfig.index;
            if (productData[simpleProductId]) {
